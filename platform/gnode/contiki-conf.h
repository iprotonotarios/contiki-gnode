...
#if WITH_CC1100
#define NETSTACK_CONF_RDC     nullrdc_driver // cxmac_driver
...
#define RIME_CONF_BROADCAST_ANNOUNCEMENT_BUMP_TIME CLOCK_SECOND 
//#define RIME_CONF_BROADCAST_ANNOUNCEMENT_MIN_TIME CLOCK_SECOND*3
